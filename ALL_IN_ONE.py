...
# Connections into the API
Initial_Connection("dcd725c415cebc7df170edf49af18d6f86e76ef75185737de5959405f4aecc56")

if not Exeception_length(r"C:\Users\cherif\Documents\behaviour detections\behaviour_summary_results.json"):
    ALL_DATA_HERE["Lockbit"] = check_for_lockbit_behaviors(r"C:\Users\cherif\Documents\behaviour detections\behaviour_summary_results.json")
    ALL_DATA_HERE["Wannacry"] = check_for_wannacry_behaviors(r"C:\Users\cherif\Documents\behaviour detections\behaviour_summary_results.json")
    ALL_DATA_HERE["Conti"] = check_for_conti_behaviors(r"C:\Users\cherif\Documents\behaviour detections\behaviour_summary_results.json")
    ALL_DATA_HERE["Maze"] = check_for_maze_behaviors(r"C:\Users\cherif\Documents\behaviour detections\behaviour_summary_results.json")
    ALL_DATA_HERE["Revil/Sodinokibi"] = check_for_revil_Sodinokibi_behaviors(r"C:\Users\cherif\Documents\behaviour detections\behaviour_summary_results.json")
    ALL_DATA_HERE["Locky"] = check_for_locky_behaviors(r"C:\Users\cherif\Documents\behaviour detections\behaviour_summary_results.json")
    ALL_DATA_HERE["Petya/NotPetya"] = check_for_petya_behaviors(r"C:\Users\cherif\Documents\behaviour detections\behaviour_summary_results.json")
    ALL_DATA_HERE["TeslaCrypt"] = check_for_TeslaCrypt_behaviors(r"C:\Users\cherif\Documents\behaviour detections\behaviour_summary_results.json")
    print(ALL_DATA_HERE)
else:
    print("Exception has been handle it, we can not found the file for the behaviour analysis")
